...
namespace duckApp
{
    ...
    public:
        ...
        */
        Script* GetScript() { return this->script.get(); }
        ...
        */
        ...
        void SetPosition(XMFLOAT3 newPosition) { this->current_position = newPosition; }
        void SetScale(XMFLOAT3 newScale) { this->current_scale = newScale; }
        void SetNextPosition(XMFLOAT3 nextPosition) { this->next_position = nextPosition; }
